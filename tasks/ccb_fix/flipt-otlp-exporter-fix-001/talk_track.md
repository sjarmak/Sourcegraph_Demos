# Demo Talk Track (flipt-otlp-exporter-fix-001)

- Why this task: `flipt-otlp-exporter-fix-001` had an MCP positive delta of **+0.001** in the ccb_fix audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.9776`, MCP reward `0.979`).
