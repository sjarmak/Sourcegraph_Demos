# Demo Talk Track (flipt-ecr-auth-oci-fix-001)

- Why this task: `flipt-ecr-auth-oci-fix-001` had an MCP positive delta of **+0.008** in the ccb_fix audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.9866`, MCP reward `0.9948`).
