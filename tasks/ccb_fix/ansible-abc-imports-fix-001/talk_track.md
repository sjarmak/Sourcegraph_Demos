# Demo Talk Track (ansible-abc-imports-fix-001)

- Why this task: `ansible-abc-imports-fix-001` had an MCP positive delta of **+0.057** in the ccb_fix audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.9429`, MCP reward `1.0`).
