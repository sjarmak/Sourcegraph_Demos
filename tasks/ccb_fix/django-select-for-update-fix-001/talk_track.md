# Demo Talk Track (django-select-for-update-fix-001)

- Why this task: `django-select-for-update-fix-001` had an MCP positive delta of **+0.110** in the ccb_fix audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.67`, MCP reward `0.78`).
- IR/result pattern observed in audit: `Speed-to-context win`, `Broader search win`.
- Task type: `bug_investigation` | Language: `python` | Difficulty: `hard`
