# Setup (openlibrary-fntocli-adapter-fix-001)
...
git clone https://github.com/internetarchive/openlibrary.git openlibrary
```

## Sourcegraph MCP repo scope

Use these Sourcegraph mirror repos for the MCP run:
- `github.com/sg-evals/openlibrary--c506c1b0`
