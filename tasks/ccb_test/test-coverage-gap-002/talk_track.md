# Demo Talk Track (test-coverage-gap-002)

- Why this task: `test-coverage-gap-002` had an MCP positive delta of **+0.060** in the ccb_test audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.94`, MCP reward `1.0`).
- Task type: `test-coverage-gap-analysis` | Language: `java` | Difficulty: `hard`
