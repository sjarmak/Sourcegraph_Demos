# Demo Talk Track (postgres-client-auth-audit-001)

- Why this task: `postgres-client-auth-audit-001` had an MCP positive delta of **+0.030** in the ccb_secure audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.74`, MCP reward `0.77`).
- IR/result pattern observed in audit: `Speed-to-context win`, `Broader search win`.
- Task type: `security_analysis` | Language: `c` | Difficulty: `hard`
