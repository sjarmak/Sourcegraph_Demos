# Demo Talk Track (django-cross-team-boundary-001)

- Why this task: `django-cross-team-boundary-001` had an MCP positive delta of **+0.200** in the ccb_secure audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.3`, MCP reward `0.5`).
- Task type: `governance_cross_team` | Language: `python` | Difficulty: `hard`
