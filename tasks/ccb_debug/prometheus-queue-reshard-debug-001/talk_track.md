# Demo Talk Track (prometheus-queue-reshard-debug-001)

- Why this task: `prometheus-queue-reshard-debug-001` had an MCP positive delta of **+0.180** in the ccb_debug audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.42`, MCP reward `0.6`).
- Task type: `cross_service_debug` | Language: `go` | Difficulty: `hard`
