# Demo Talk Track (envoy-migration-doc-gen-001)

- Why this task: `envoy-migration-doc-gen-001` had an MCP positive delta of **+0.140** in the ccb_document audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.65`, MCP reward `0.79`).
- Task type: `migration_guide` | Language: `cpp` | Difficulty: `hard`
