# Demo Talk Track (vscode-api-doc-gen-001)

- Why this task: `vscode-api-doc-gen-001` had an MCP positive delta of **+0.020** in the ccb_document audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.98`, MCP reward `1.0`).
- Task type: `api_reference` | Language: `typescript` | Difficulty: `hard`
