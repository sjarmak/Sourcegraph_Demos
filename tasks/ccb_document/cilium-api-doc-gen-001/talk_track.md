# Demo Talk Track (cilium-api-doc-gen-001)

- Why this task: `cilium-api-doc-gen-001` had an MCP positive delta of **+0.020** in the ccb_document audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.96`, MCP reward `0.98`).
- Task type: `api_reference` | Language: `go` | Difficulty: `hard`
