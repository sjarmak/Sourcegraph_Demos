# Demo Talk Track (terraform-arch-doc-gen-001)

- Why this task: `terraform-arch-doc-gen-001` had an MCP positive delta of **+0.170** in the ccb_document audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.42`, MCP reward `0.59`).
- Task type: `architecture_doc` | Language: `go` | Difficulty: `hard`
