# Demo Talk Track (django-orm-query-arch-001)

- Why this task: `django-orm-query-arch-001` had an MCP positive delta of **+0.080** in the ccb_design audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.91`, MCP reward `0.99`).
- Task type: `architectural_understanding` | Language: `python` | Difficulty: `hard`
