# Demo Talk Track (camel-routing-arch-001)

- Why this task: `camel-routing-arch-001` is a strong demo candidate with a reference verifier delta of **+0.730** in the ccb_design benchmark run.
