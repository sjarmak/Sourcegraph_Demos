# Demo Talk Track (django-rate-limit-design-001)

- Why this task: `django-rate-limit-design-001` had an MCP positive delta of **+0.100** in the ccb_design audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.9`, MCP reward `1.0`).
- Task type: `enterprise_conflicting_docs` | Language: `python` | Difficulty: `hard`
