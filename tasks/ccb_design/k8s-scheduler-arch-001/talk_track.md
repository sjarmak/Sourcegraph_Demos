# Demo Talk Track (k8s-scheduler-arch-001)

- Why this task: `k8s-scheduler-arch-001` is a strong demo candidate with a reference verifier delta of **+0.720** in the ccb_design benchmark run.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.0`, MCP reward `0.72`).
