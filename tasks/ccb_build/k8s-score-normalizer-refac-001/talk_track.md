# Demo Talk Track (k8s-score-normalizer-refac-001)

- Why this task: `k8s-score-normalizer-refac-001` had an MCP positive delta of **+0.200** in the ccb_build audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.58`, MCP reward `0.78`).
- Task type: `cross_file_refactoring` | Language: `go` | Difficulty: `hard`
