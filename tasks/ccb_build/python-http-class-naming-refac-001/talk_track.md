# Demo Talk Track (python-http-class-naming-refac-001)

- Why this task: `python-http-class-naming-refac-001` had an MCP positive delta of **+0.040** in the ccb_build audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.84`, MCP reward `0.88`).
