# Demo Talk Track (envoy-grpc-server-impl-001)

- Why this task: `envoy-grpc-server-impl-001` had an MCP positive delta of **+0.040** in the ccb_build audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.4`, MCP reward `0.44`).
