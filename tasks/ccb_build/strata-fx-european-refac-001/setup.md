# Setup (strata-fx-european-refac-001)
...
- `github.com/sg-evals/Strata--66225ca9`

## Dependencies (Linux / macOS / Windows)

Install these tools before running the task locally:

- Required tools: `git`, `curl`, `python3`, `java`, `maven`

### Linux (Ubuntu/Debian)

```bash
sudo apt-get update
sudo apt-get install -y git curl python3 python3-pip openjdk-17-jdk maven
```
...
brew install git curl python openjdk@17 maven
