...
git clone https://github.com/sg-evals/numpy--a639fbf5.git numpy--a639fbf5
git clone https://github.com/sg-evals/scikit-learn--cb7e82dd.git scikit-learn--cb7e82dd
git clone https://github.com/sg-evals/pandas--41968da5.git pandas--41968da5
```

## Sourcegraph MCP repo scope

Use these Sourcegraph mirror repos for the MCP run:
- `github.com/sg-evals/numpy--a639fbf5`
- `github.com/sg-evals/scikit-learn--cb7e82dd`
- `github.com/sg-evals/pandas--41968da5`
