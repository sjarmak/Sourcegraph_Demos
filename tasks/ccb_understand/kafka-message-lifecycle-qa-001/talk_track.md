# Demo Talk Track (kafka-message-lifecycle-qa-001)

- Why this task: `kafka-message-lifecycle-qa-001` had an MCP positive delta of **+0.140** in the ccb_understand audit.
- Compared configs: `baseline-local-direct` -> `mcp-remote-direct` (baseline reward `0.86`, MCP reward `1.0`).
- IR/result pattern observed in audit: `Speed-to-context win`.
- Task type: `dataflow_qa` | Language: `java` | Difficulty: `hard`
